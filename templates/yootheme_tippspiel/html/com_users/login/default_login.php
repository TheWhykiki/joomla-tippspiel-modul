...
?>
<div class="com-users-login login uk-card uk-card-secondary">
    ...
    <ul class="com-users-login__options list-group">
        <a class="com-users-login__reset list-group-item uk-button uk-button-primary" href="<?php echo Route::_('index.php?option=com_users&view=reset'); ?>">
            <?php echo Text::_('COM_USERS_LOGIN_RESET'); ?>
        </a>
        <a class="com-users-login__remind list-group-item  uk-button uk-button-primary" href="<?php echo Route::_('index.php?option=com_users&view=remind'); ?>">
            <?php echo Text::_('COM_USERS_LOGIN_REMIND'); ?>
        </a>
        <?php if ($usersConfig->get('allowUserRegistration')) : ?>
            <a class="com-users-login__register list-group-item  uk-button uk-button-primary" href="<?php echo Route::_('index.php?option=com_users&view=registration'); ?>">
